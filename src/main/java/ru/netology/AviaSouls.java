...
public class AviaSouls {
    ...
    /**
     * Метод поиска билетов по маршруту с сортировкой по цене (по умолчанию)
    ...
    public Ticket[] search(String from, String to) {
        ...
        // Сортируем результат по цене (естественный порядок)
        Arrays.sort(result);
        return result;
    }

    /**
     * Метод поиска билетов по маршруту с сортировкой по переданному компаратору
     * @param from Откуда вылетаем
     * @param to Куда прилетаем
     * @param comparator Компаратор для сортировки
     * @return Массив из подходящих билетов, отсортированных по логике компаратора
     */
    public Ticket[] searchAndSortBy(String from, String to, Comparator<Ticket> comparator) {
        ...
        // Сортируем результат по переданному компаратору
